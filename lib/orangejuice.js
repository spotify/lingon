  ...
  this.gulp.task('oj:assets', function() {
    ...
    for(var i=0;i<_this.sourceFiles.length;i++) {
      ...
      if(sourceFile.patterns.length > 0) {
        ...
        // Add preprocessors for filetypes (Before concat)
        // pipes = pipes.concat(
        //   _this.pipesForFileExtensions(
        //     sourceFile.name, 
        //     _this.preProcessors));
        ...
        // Add preprocessors for filetypes
        // pipes = pipes.concat(
        //   _this.pipesForFileExtensions(
        //     sourceFile.name, 
        //     _this.preProcessors));
      ...
      console.log(
        ...
        sourceFile.type, gutil.colors.green(sourceFile.path), 
        '=>', 
...
OJ.prototype.pipesForFileExtensions = function(filename, pipeMap) {
  return utils.pipesForFileExtensions(filename, pipeMap, this.currentConfig());
};
...
OJ.prototype.applyPipes = utils.applyPipes;
