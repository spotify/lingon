...
Lingon.prototype.registerTask = function(task, callback) {
...
Lingon.prototype.preProcessor = function(extension, factory/*deprecated argument*/) {
  this.preProcessors[extension] = (factory ? [factory] : this.preProcessors[extension]) || [];

  return this.preProcessors[extension];
}

Lingon.prototype.postProcessor = function(extension, factory/*deprecated argument*/) {
