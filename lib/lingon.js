...
var Lingon = function(rootPath, argv) {
  ...
  this.sourcePath = defaultConfig.sourcePath;
  this.buildPath = defaultConfig.buildPath;
  this.validDirectiveFileTypes = defaultConfig.validDirectiveFileTypes;
  this.ignorePrefixPattern = defaultConfig.ignorePrefixPattern;
...
Lingon.prototype.getEnvironment = function() {
  if(!this.__environment) {
    this.__environment = new Environment({
      ...
      ignorePrefixPattern: this.ignorePrefixPattern
    });
  }
