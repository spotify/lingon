...
var ExtensionMapper    = require('./fileExtensionMapper');
...
Lingon.prototype.prepareOutputMap = function() {
  ...
  sourceFiles.forEach(function(sourceFile){
    ...
    var destFilename = _this.fileExtensionMapper.transform(sourceFilename);
...
Lingon.prototype.rewriteExtension = function(extension, rewrite) {
  this.fileExtensionMapper.set(extension, rewrite);
};
