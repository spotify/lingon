...
var Lingon = function(rootPath, argv) {
  ...
  // TODO: Temporary - Remove in 2.0.0!
  // Temporary fix: context was renamed to global for the upcoming 2.0.0 release
  // but the commit ended up on master since other changes depended
  // on it. Remove this in 2.0.0
  this.context = {};
...
Lingon.prototype.build = function(callback, requestPaths) {
  ...
  // TODO: Temporary - Remove in 2.0.0!
  // This should be removed when lingon.context 
  // has been renamed to lingon.global.
  var merge = require('merge');
  var mergedContextGlobal = merge(this.context, this.global);
