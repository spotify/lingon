module.exports = {
  ...
  getRegisteredExtensions: function(sourceFilename, extensionMap, processorStores) {
    ...
    for(var extension in extensionMap) {
      ...
      if(this.registeredWithProcessor(processorStores, extension) || opts && opts.always) {
